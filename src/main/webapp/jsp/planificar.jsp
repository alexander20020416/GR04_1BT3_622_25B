    ...
    <main>
        <div class="form-container">
            ...
            <p class="form-description">
                Complete los siguientes campos para registrar una nueva actividad académica.
            </p>
            ...
            <form action="${pageContext.request.contextPath}/planificar" method="post" class="form">
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           name="titulo"
                           class="form-control"
                           placeholder="Ej: Proyecto de Metodologías Ágiles"
                           required
                           maxlength="200">
                </div>
        ...
        <div class="info-box">
            ...
            <p>Este formulario implementa el caso de uso <strong>"Planificar Actividades"</strong> del Incremento 1.</p>
            <ul>
                <li>Todos los campos marcados con (*) son obligatorios</li>
                <li>La actividad se guardará con estado "Pendiente"</li>
